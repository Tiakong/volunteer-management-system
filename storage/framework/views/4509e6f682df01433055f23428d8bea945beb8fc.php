	...
	<div class='card col-sm-12 text-right' style='margin:4px;'>
		<div id='guildance' title='To guild you what field is required' style='margin:2px'>
			<div class='card-body row'>
				<?php echo Form::label('preset', 'Guidance', [
					'class' => 'control-label col-sm-3 p-2',
				]); ?>

				<div class="col-sm-9">
					<?php echo Form::select('category', Common::$DataExportGuidance, null, [
						'id'	=> 'input_guild',
		...
		<div id='eventName'  hidden title='Showing volunteer that enrolled for this event'  style='margin:2px'>
			<div class='card-body row'>
				<?php echo Form::label('event-name', 'Event', [
					'class' => 'control-label col-sm-3 p-2',
				]); ?>
...
<?php echo $__env->make('admin.master', ['title'=>"Data Export"], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>