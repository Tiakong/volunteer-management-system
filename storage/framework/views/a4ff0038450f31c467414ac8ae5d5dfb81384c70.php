        ...
        <div class="button-div">
          ...
          <div class="program-button-div">
              <div class="dropdown">
                  ...
                  <li><?php echo link_to_route('event.admin-show',
                              $title = $code,
                              $parameters = [
                                  'code' => $code]); ?></li>
...
{
 $.ajax({
  url:"<?php echo e(route('event.select-tab',['code'=>$programme])); ?>",
  method:'GET',
  data:{query:page_id},
  dataType:'json',
  success:function(data)
  {
   ...
   var i;
   var redirect_route = "<?php echo e(route('event.admin-show-detail')); ?>";
