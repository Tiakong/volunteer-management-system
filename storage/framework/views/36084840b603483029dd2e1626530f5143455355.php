...
<div class="'col-sm-12 text-center">
	...
	<br/>
	<form name='submitForm' class="border border-light p-5" method="post" action="<?php echo e(route('officework.update',$officework->oid)); ?>">
		...
		<div class="form-group row">
			...
			<div class="col-sm-9">
				<textarea type="text" name="description" class="form-control mb-4" placeholder="Voluntary Administrative Work Description" rows='6'><?php echo e($officework->description); ?></textarea>
			</div>
		</div>
		<div class="form-group row">
			<div class='col-sm-3 p-2'>
			...
			<div class="col-sm-9">
				<input type="text" name="serve_hour" class="form-control mb-4" placeholder="Eg: 3.5" value="<?php echo e($officework->serve_hour); ?>"/>
			</div>
		</div>
	</form>
...
<?php echo $__env->make('officework.master', ['title'=>'Edit Voluntary Administrative Work'], array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>