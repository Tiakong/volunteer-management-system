...
<div class="event-form-container">
	<div class="button-div">
		<div class="program-button-div">
			<div class="dropdown">
				<button class="program-button btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Programme</button>
	...
	<ul class="nav nav-tabs">
		<li class='active'><a data-toggle="tab" id="all_event" href="">All Event</a></li>
